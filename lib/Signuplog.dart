...
class Signuplog extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(elevation: 0,
      ...
      body: Center(
        child: Column(
          children: [SizedBox(height: 30,),Text("Sign UP",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
          SizedBox(height: 30,),Text("Create an Account,its Free"),
          SizedBox(height: 30),
          Padding(
          ...
          Padding(
            ...
            SizedBox(height: 30),
            MaterialButton(onPressed: (){},shape: StadiumBorder(),color: Colors.red,height:60,minWidth: 300,child: Text("Sign UP")),
        TextButton(onPressed: (){}, child: RichText(text: TextSpan(style: TextStyle(
